...
use Extensions\Freshbooks\Exception;
use Extensions\Freshbooks\XmlDomConstruct;
/**
...
class Request
{
    ...
    public function request()
    {
        ...
        {
            throw new Exception('You need to call FreshBooksRequest::init($domain, $token) with your domain and token.');
        }
